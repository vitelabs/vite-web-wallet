const InsufficientQuota = '配额不足';
const StakeVITE = '抵押VITE';
const Action = '操作';
const SBPRegistration = '注册SBP';
const NodeName = '节点名称';
const Voting = '投票';
const MyVoting = '我的投票';
...
module.exports = {
    ...
    vote: {
        ...
        section1: {
            title: MyVoting,
            head: ['节点名称', '节点状态', MyVoting, '投票状态', Action],
            nodeStatusMap: {
                1: '正在候选',
                2: '停止候选'
            },
