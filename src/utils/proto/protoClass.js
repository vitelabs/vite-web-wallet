...
const TickerStatisticsProto = new Type('TickerStatisticsProto')
    ...
    .add(new Field('tradeToken', 2, 'string'))
    .add(new Field('tradeTokenSymbol', 3, 'string'))
    .add(new Field('quoteToken', 4, 'string'))
    .add(new Field('quoteTokenSymbol', 5, 'string'))
    ...
    .add(new Field('highPrice', 10, 'string'))
    .add(new Field('lowPrice', 11, 'string'))
    .add(new Field('quantity', 12, 'string'))
    .add(new Field('amount', 13, 'string'))
    .add(new Field('quantityPrecision', 14, 'int32'))
